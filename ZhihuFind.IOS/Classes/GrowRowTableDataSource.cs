...
namespace ZhihuFind.IOS.Classes
{
    public class GrowRowTableDataSource : UITableViewDataSource
    {
        ...
        public GrowRowTableDataSource(DailysViewController controller)
        {
            // Initialize
        ...
        {
            var cell = tableView.DequeueReusableCell(CellID, indexPath) as DailysTableCell;
